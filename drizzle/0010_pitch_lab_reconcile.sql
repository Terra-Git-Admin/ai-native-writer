...
CREATE INDEX IF NOT EXISTS `idx_pitch_ideas_workspace_position` ON `pitch_ideas` (`workspace_id`,`position`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_pitch_sources_workspace` ON `pitch_sources` (`workspace_id`);
--> statement-breakpoint
